...
@interface ViewController ()<UITableViewDataSource,UITableViewDelegate,CYSectionIndexViewDelegate,CYSectionIndexViewDataSource>
...
- (void)viewDidLoad {
     ...
     [self.sectionIndexView registerNib:[UINib nibWithNibName:identifierCYCustomSectionIndexCell bundle:nil] forSectionIndexCellReuseIdentifier:identifierCYCustomSectionIndexCell];
     self.sectionIndexView.delegate = self;
     self.sectionIndexView.dataSource = self;
//     self.sectionIndexView.isShowCallout = NO;
     self.sectionIndexView.calloutType = CYCalloutViewTypeForWeChat;
